	...
	checkAllDataAvailable: function(){
	  ...
	  if ((this.normalData != null) & (this.fftData != null) & (this.normalLimits != null ) & (this.fftLimits!= null)  ) {
	    ...
	    // si todos los datos están disponibles, crea las regiones.
			this.regionsCONSERVATION = new TRegions('CONSERVATION',this.runid, this.graphName ,'aboveFFT','aboveTD',this.loadRegionDone.bind(this),'Sequence identity too high to determine specific conserved motives');
      // 
      this.regionsDIVERGENCE = new TRegions('DIVERGENCE',this.runid, this.graphName ,'belowFFT','belowTD',this.loadRegionDone.bind(this),'Sequences can be considered identical');
      //
      this.regionsSNP = new TRegions('SNP',this.runid, this.graphName ,'snp','snpTD',this.loadRegionDone.bind(this),'No SNP found');
